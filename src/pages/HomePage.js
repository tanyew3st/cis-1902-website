...
const HomePage = () => {
  return (
    <div className="container mx-auto p-4 max-w-5xl"> {/* Adjusted the max-width */}
      ...
      <section className="mb-8">
        ...
        <p>Python is a high-level, interpreted programming language known for its simplicity and versatility. It's widely used in various fields, from web development to data science and machine learning. In this course, we explore why Python is a preferred language for developers and data scientists alike.</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside">
          <li><strong>10% Quizzes</strong> - Regular quizzes to assess understanding.</li>
          <li><strong>10% Attendance</strong> - Active participation in classes.</li>
          <li><strong>60% Weekly Assignments</strong> - Practical tasks to apply learning.</li>
          <li><strong>20% Final Project</strong> - A comprehensive project encapsulating course topics.</li>
        </ul>
      </section>
